...
def infoinput_page():
    ...
    # button for submitting path info, i.e. broken roads/bridges
...
def main_window():
    ...
    window.title("Sign-in or Sign-out")
    window.resizable(False, False)
    window.config(bg="#ebfffe")
    center_window(window)  # calls the function for centering window
